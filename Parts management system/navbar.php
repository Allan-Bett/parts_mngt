          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav gabali">
                ...
                <li><a href="myparts.php">My Part(s)</a></li>
                <li><a href="partsregistration.php">Parts Registration</a></li>
                <li><a href="partsinspection.php"> Parts Inspection</a></li>
                <li><a href="onlinesearch.php">Online Search</a></li>
                <li><a href="notice&news">Notice & News</a></li>
                <li><a href="myfeedback">My Feedback</a></li>
                <!-- <li><a href="myfeedback0">My Feedback</a></li> -->
